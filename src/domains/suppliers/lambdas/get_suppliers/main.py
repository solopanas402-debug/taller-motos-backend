...
def lambda_handler(event, context):
    ...
    try:
        ...
        print(f"Consultando proveedores - Página: {page}, Límite: {limit}, Búsqueda: {search}")
        ...
        print(f"Consulta exitosa - Encontrados: {len(result.get('data', result)) if isinstance(result, dict) else len(result)} proveedores")
        ...
        return ResponseUtils.internal_server_error_response(
            "Ha ocurrido un problema interno al consultar los proveedores"
        )