...
def lambda_handler(event, context):
    ...
    try:
        ...
        print(f"Consultando reparaciones - Página: {page}, Límite: {limit}, Búsqueda: {search}")
        ...
        print(f"Consulta exitosa - Encontradas: {len(result.get('data', result)) if isinstance(result, dict) else len(result)} reparaciones")
        ...
        return ResponseUtils.internal_server_error_response(
            "Ha ocurrido un problema interno al consultar las reparaciones"
        )
