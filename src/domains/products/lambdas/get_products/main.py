...
def lambda_handler(event, context):
    ...
    search = params.get("search")
        ...
        print(f"Consultando productos - Página: {page}, Límite: {limit}, Búsqueda: {search}")
        ...
        print(f"Consulta exitosa - Encontrados: {len(result.get('data', result)) if isinstance(result, dict) else len(result)} productos")
        ...
        return ResponseUtils.internal_server_error_response(
            "Ha ocurrido un problema interno al consultar los productos"
        )
